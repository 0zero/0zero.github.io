        ...
        <div className="container relative z-10 px-4">
          ...
          <div className="mt-8 max-w-3xl">
            <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl md:text-5xl">
              Tech Career & Projects
            </h1>
            <p className="mt-4 text-lg text-white/70 md:text-xl">
              A showcase of my professional work in software development, data engineering, and machine learning.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container px-4">
          ...
          <div className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <ProjectCard
              ...
              description="Built a scalable ETL pipeline processing 10TB of data daily using Apache Kafka and Spark."
              tags={["Kafka", "Spark", "AWS", "Big Data"]}
              imageUrl="/placeholder.svg?height=400&width=600"
            />
            <ProjectCard
              title="Predictive Maintenance Dashboard"
              description="Created a dashboard for predicting equipment failures in manufacturing using sensor data."
              tags={["Python", "React", "Machine Learning", "IoT"]}
              imageUrl="/placeholder.svg?height=400&width=600"
            />
            <ProjectCard
              title="Cloud Cost Optimization Tool"
              description="Developed a tool that analyzes cloud resource usage and recommends optimizations."
              tags={["AWS", "Terraform", "Python", "Cost Optimization"]}
              imageUrl="/placeholder.svg?height=400&width=600"
            />
            <ProjectCard
              title="Open Source Data Connector"
              description="Created and maintained a popular open-source connector for data integration."
              tags={["Open Source", "Java", "API", "Data Integration"]}
              imageUrl="/placeholder.svg?height=400&width=600"
            />
            <ProjectCard
              title="Distributed Caching System"
              description="Designed a high-performance distributed caching system for web applications."
              tags={["Redis", "Go", "Distributed Systems", "Performance"]}
              imageUrl="/placeholder.svg?height=400&width=600"
            />
            <ProjectCard
              title="DevOps Automation Suite"
              description="Built a suite of tools for automating CI/CD pipelines and infrastructure management."
